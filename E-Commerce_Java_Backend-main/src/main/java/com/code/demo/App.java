...
public class App {
    ...
    private static void addTestData(Session session) {
       ...
       Category category1 = new Category();
        ...
        category1.setDescription("Electronics gadgets");
        session.save(category1);

        Category category2 = new Category();
        category2.setName("Fashion");
        category2.setDescription("Fahion and style");
        session.save(category2);

        // Insert Products
        Product product1 = new Product();
        product1.setName("Smartphone");
        product1.setPrice(BigDecimal.valueOf(14999.99));
        ...
        product2.setPrice(BigDecimal.valueOf(88999.99));
        ...
        product3.setPrice(BigDecimal.valueOf(219.99));
        ...
        // Insert User
        User user1 = new User();
        user1.setUsername("Sachin Tandulkar");
        user1.setPassword("Sachin_password1");
        user1.setEmail("Sachin10@example.com");
        user1.setRole(Role.CUSTOMER);
        session.save(user1);

        User user2 = new User();
        user2.setUsername("Sourav Ganguly");
        user2.setPassword("captain_password2");
        ...
        order1.setTotalAmount(BigDecimal.valueOf(14999.99));
        ...
        orderDetails1.setUnitPrice(BigDecimal.valueOf(14999.99));
